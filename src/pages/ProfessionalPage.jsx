...
const professionals = [
  {
    ...
    description: "Especialista en evaluaciones neurocognitivas y desarrollo infantil con más de 15 años de experiencia en el campo de la neuropsicología clínica.",
    strengths: [
  ...
  },
  {
    ...
    description: "Experta en orientación vocacional y estrategias de aprendizaje, dedicada a acompañar a jóvenes en la construcción de su proyecto de vida.",
    strengths: [
  ...
  },
  {
    ...
    description: "Especialista en selección de personal y neuroliderazgo, con amplia experiencia en el desarrollo de equipos de alto rendimiento.",
    strengths: [
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-primary mb-4">Profesional no encontrado</h1>
          ...
          <div className="container">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-xl text-accent font-medium mb-6">{professional.title}</p>
          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {professional.strengths.map((strength, index) => (
                <motion.div
                  key={index}
                  className="bg-white p-6 rounded-lg shadow-sm border border-stone-light text-center"
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="container">
            ...
            >
              ...
              <p className="text-primary/80 mb-6 max-w-2xl mx-auto">
                Contáctanos para coordinar una cita con {professional.name.split(' ')[1]} {professional.name.split(' ')[2]} 
                y comenzar tu proceso de acompañamiento profesional.
              </p>
              <motion.a 
                href="/#contact" 
                className="btn-primary"
