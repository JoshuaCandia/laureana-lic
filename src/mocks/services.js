export const services = [
  ...
  },
  {
    ...
    description:
      "Procesos de reclutamiento y selección basados en competencias, utilizando herramientas psicométricas y entrevistas especializadas.",
  ...
  },
  {
    ...
    description:
      "Evaluaciones integrales para niños y adolescentes con dificultades de aprendizaje, atención o desarrollo.",
  ...
  },
  {
    ...
    description:
      "Consultoría especializada para instituciones educativas en estrategias de enseñanza y manejo de dificultades de aprendizaje.",
  ...
  },
  {
    ...
    description:
      "Formación en estrategias didácticas cerebro-compatibles para optimizar el proceso de enseñanza-aprendizaje.",
  ...
  },
  {
    ...
    description:
      "Capacitación para directivos en liderazgo basado en neurociencias, mejorando la gestión de equipos y toma de decisiones.",
