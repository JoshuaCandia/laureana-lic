      ...
      <div className="container">
        ...
        >
          ...
          <p className="section-subtitle">
            ¿Tienes alguna consulta o quieres agendar una cita? Completa el formulario 
        ...
        >
          <motion.div variants={itemVariants}>
            <div className="bg-white p-8 rounded-lg shadow-sm border border-stone-light">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input 
                    ...
                    required 
                    className="w-full px-4 py-2 border border-stone-light rounded-md focus:ring-accent focus:border-accent transition-colors"
                  />
                </div>
                ...
                <div>
                  <label htmlFor="service" className="block text-sm font-medium text-primary/80 mb-1">
                    Servicio de interés
                  </label>
                  <select 
                    id="service" 
                  ...
                  >
                    ...
                    <option value="evaluaciones-neurocognitivas">Evaluaciones Neurocognitivas</option>
                    <option value="asesoramiento-escuelas">Asesoramiento a Escuelas</option>
                    <option value="capacitacion-docente">Capacitación Docente</option>
          ...
          <motion.div variants={itemVariants}>
            <div className="bg-white p-8 rounded-lg shadow-sm border border-stone-light h-full">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <a href="mailto:info@puntodepartida.com" className="text-primary/80 hover:text-accent transition-colors">
                ...
                >
                  ...
                  <div>
                    ...
                    <a href="tel:+5491123456789" className="text-primary/80 hover:text-accent transition-colors">
                      +54 9 11 2345-6789
                    </a>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/5491123456789" className="text-primary/80 hover:text-accent transition-colors">
                      +54 9 11 2345-6789
                    </a>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="text-accent hover:text-accent/80 text-sm transition-colors">
                      Ver en Google Maps
                    </a>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    <h4 className="font-medium text-primary">Horarios de atención</h4>
                    <p className="text-primary/80">
